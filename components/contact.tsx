      ...
      <div className='px6 container flex flex-col justify-between py-12 text-lg md:flex-row'>
        ...
        >
          <h1 className='text-[40px] font-bold uppercase leading-[3rem]'>
            Travaillons<br /> <span className='under-line'>Ensemble</span>
          </h1>
        </motion.div>
        <motion.form
        ...
        >
          ...
          ></textarea>
          <button className='w-50 mt-12 flex items-center justify-between gap-x-2 rounded-full bg-gray-700 px-4 py-3 transition-all duration-300 hover:bg-lighted hover:text-secondary hover:transition-all'>
            <p className='text-md capitalize'>Envoyé un Message</p>
